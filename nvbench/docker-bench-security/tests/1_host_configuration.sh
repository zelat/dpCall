...
check_1_1_1() {
  local id="1.1.1"
  local desc="确保为容器创建了一个单独的分区 (Automated)"
...
check_1_1_2() {
  local id="1.1.2"
  local desc="确保只有受信任的用户才能控制Docker守护进程 (Automated)"
...
check_1_1_3() {
  local id="1.1.3"
  local desc="确保为Docker守护进程配置了审计 (Automated)"
...
check_1_1_4() {
  local id="1.1.4"
  local desc="确保为containerd文件和目录-/run/containerd配置了审计 (Automated)"
...
check_1_1_5() {
  local id="1.1.5"
  local desc="确保为docker文件和目录-/var/lib/docker配置了审计 (Automated)"
...
check_1_1_6() {
  local id="1.1.6"
  local desc="确保为docker文件和目录-/etc/docker配置了审计 (Automated)"
...
check_1_1_7() {
  local id="1.1.7"
  local desc="确保为docker文件和目录-docker.service配置了审计 (Automated)"
  local remediation
...
check_1_1_8() {
  local id="1.1.8"
  local desc="确保为containerd文件和目录-containerd.sock配置了审计 (Automated)"
  local remediation
...
check_1_1_9() {
  local id="1.1.9"
  local desc="确保为docker文件和目录-docker.socket配置了审计 (Automated)"
  local remediation
...
check_1_1_10() {
  local id="1.1.10"
  local desc="确保为docker文件和目录-/etc/default/docker配置了审计 (Automated)"
...
check_1_1_11() {
  local id="1.1.11"
  local desc="确保为docker文件和目录-/etc/docker/daemon.json配置了审计 (Automated)"
...
check_1_1_12() {
  local id="1.1.12"
  local desc="确保为containerd文件和目录/etc/containerd/config.toml配置了审计 (Automated)"
...
check_1_1_13() {
  local id="1.1.13"
  local desc="确保为docker文件和目录-/etc/sysconfig/docker配置了审计 (Automated)"
...
check_1_1_14() {
  local id="1.1.14"
  local desc="确保为containerd文件和目录-/usr/bin/containerd配置了审计 (Automated)"
...
check_1_1_15() {
  local id="1.1.15"
  local desc="确保为containerd文件和目录-/usr/bin/containerd-shim配置了审计 (Automated)"
...
check_1_1_16() {
  local id="1.1.16"
  local desc="确保为containerd文件和目录-/usr/bin/containerd-shim-runc-v1配置了审计 (Automated)"
...
check_1_1_17() {
  local id="1.1.17"
  local desc="确保为containerd文件和目录-/usr/bin/containerd-shim-runc-v2配置了审计 (Automated)"
...
check_1_1_18() {
  local id="1.1.18"
  local desc="确保为docker文件和目录-/usr/bin/runc配置了审计 (Automated)"
...
check_1_2_1() {
  local id="1.2.1"
  local desc="确保容器宿主机已完成加固 (Manual)"
...
check_1_2_2() {
  local id="1.2.2"
  local desc="确保更新docker到最新版本 (Manual)"
