...
const CVEDatabaseFolder = "/etc/secvector/db/"

const ProfileFolder string = "/var/secvector/profile/"
...
const (
	NeuVectorLabelImage string = "secvector.image"
	NeuVectorLabelRole  string = "secvector.role"
